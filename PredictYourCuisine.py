...
italian_ingredients = {}
italian_cuisine_ingredients = train_content[train_content['cuisine'].isin(['italian'])]
italian_ingredients_array = np.array(italian_cuisine_ingredients)
# print(italian_ingredients_array[1])
for italian_ingtrdient in italian_ingredients_array:
#     print(italian_ingtrdient)
    for i in italian_ingtrdient[2]:
        if i not in italian_ingredients:
            italian_ingredients[i] = 1
        else:
            italian_ingredients[i] += 1
